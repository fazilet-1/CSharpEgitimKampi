...
namespace _02_Variables
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //double oranangeTotalPrice = orangeGram * orangePrice;
            ...
            //Console.WriteLine("Alınan Ürün: Portakal - " + " Birim Fiyatı: " + orangePrice + " -Gramaj: " + orangeGram + " -Toplam Tutar: " + oranangeTotalPrice);
            ...
            //double shoppingTotalPrice = appleTotalPrice + oranangeTotalPrice + strawberryTotalPrice + potatoTotalPrice + tomatoTotalPrice;
