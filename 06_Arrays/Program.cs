...
namespace _06_Arrays
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //int[] numbers = { 4, 85, 96, 75, 125, 488, 522, 7456, 2365, 1120 };
            ...
            //Array.Sort(numbers); //dizideki elemanları artan sırayla düzenler
            //for (int i = 0; i < numbers.Length; i++)
            //{
            //    Console.WriteLine(numbers[i]);
            //}
            ...
            //int[] numbers = { 45, 85, 52, 41, 86, 10, 22, 35 };
            //Array.Reverse(numbers); //dizideki elemanları tersten sıralar
            //for (int i = 0; i < numbers.Length; i++)
            //{
            //    Console.WriteLine(numbers[i]);
            //}
